...
;#define MyAppName "BattleTeams2"
;#define MyAppVerName "BattleTeams2_Win7_Setup"
;#define MyAppPublisher "VTCGame"
;#define MyAppURL "http://vtcgame.vn"
;#define MyAppExeName "BattleTeams2_Win7_Setup.exe"
	...
	#define eventTypePrefix="VTCPLUS_W7_B2C_1.0.0.15W7b1515012022p"
#endif
...
AppName=BattleTeams2
AppVerName=BattleTeams2 launcher 
AppPublisher=VTCGame
AppPublisherURL={#url}
AppSupportURL={#url}
AppUpdatesURL={#url}
DefaultDirName={pf}\BattleTeams2
DefaultGroupName=VTCGame\BattleTeams2

DisableProgramGroupPage=true

OutputDir={#outputDirectory}
OutputBaseFilename={#OutputSetupFilename}
SetupIconFile={#rsBP}\inno\inno-images\truykichpc\Iconapp.ico

UninstallIconFile={#rsBP}\inno\inno-images\uninstall.ico
Compression=lzma
SolidCompression=yes
WindowVisible=false
WizardImageFile={#rsBP}\inno\inno-images\truykichpc\Iconapp-medium.bmp
WizardSmallImageFile={#rsBP}\inno\inno-images\truykichpc\Iconapp-small.bmp
DirExistsWarning=no
...
Name: "vietnamesedone"; MessagesFile: "compiler:Languages\EnglishBritish.isl"
...
[Icons]
Name: {group}\BattleTeams2; Filename: {app}\BattleTeams2.exe; WorkingDir: {app}
Name: {group}\Uninstall;IconFileName:{#rsBP}\inno\inno-images\uninstall.ico; Filename: {uninstallexe}
Name: {userdesktop}\BattleTeams2; Filename: {app}\BattleTeams2.exe; WorkingDir: {app}; IconFilename: "{app}\Iconapp.ico"; Tasks: desktopicon
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\BattleTeams2; Filename: {app}\BattleTeams2.exe; WorkingDir: {app}
...
Filename: {app}\BattleTeams2.exe; Description: {cm:LaunchProgram,BattleTeams2}; Flags: nowait postinstall skipifsilent
