...
;#define MyAppName "Truy Kich PC"
;#define MyAppVerName "TruyKichPC_Win7_Setup"
;#define MyAppPublisher "VTCGame"
;#define MyAppURL "http://vtcgame.vn"
;#define MyAppExeName "TruyKichPC_Win7_Setup.exe"
	...
	#define eventTypePrefix="VTCPLUS_W7_B2C_1.0.0.1W7b1109072023p"
#endif
...
AppName=Truy Kich PC
AppVerName=Truy kích PC - Bản cài đặt qua launcher 
AppPublisher=VTCGame
AppPublisherURL={#url}
AppSupportURL={#url}
AppUpdatesURL={#url}
DefaultDirName={pf}\TruyKichPC
DefaultGroupName=VTCGame\Truy Kich PC

DisableProgramGroupPage=true

OutputDir={#outputDirectory}
OutputBaseFilename={#OutputSetupFilename}
SetupIconFile={#rsBP}\inno\inno-images\Iconapp.ico

UninstallIconFile={#rsBP}\inno\inno-images\uninstall.ico
Compression=lzma
SolidCompression=yes
WindowVisible=false
WizardImageFile={#rsBP}\inno\inno-images\Iconapp-medium.bmp
WizardSmallImageFile={#rsBP}\inno\inno-images\Iconapp-small.bmp
DirExistsWarning=no
...
Name: {userdesktop}\Truy Kich PC; Filename: {app}\TruyKichPC.exe; WorkingDir: {app}; IconFilename: "{app}\Iconapp.ico"; Tasks: desktopicon
...
Filename: {app}\TruyKichPC.exe; Description: {cm:LaunchProgram,Truy Kich PC}; Flags: nowait postinstall skipifsilent
