...
@echo off
cls
CALL set buildPath=F:\VTC\Gitlab\Launcher\vtc-esport-client\builds_test
CALL set rsBPB=F:\VTC\Gitlab\Launcher\launcher_create_setup_sign\
CALL set outputDirectory=F:\VTC\Gitlab\Launcher\launcher_create_setup_sign\inno\setup-output-files\
CALL set buildVersion="1.0.0.2"
CALL set buildNumberAndDate="b1227082023p"
for %%w in (Win10) do (
	CALL:ECHORED %%w
	...
	REM cc1 cc2 cc3 chimsedinang ckg duo duongdh fb1 fb2 fb3 fus gamehome gamingx gcp gctruykichpc gg1 gg2 gg3 hubservices kingzone mixed other rip113 spartacus viking waystation
	for %%x in (cc1 cc2 cc3 chimsedinang ckg duo duongdh fb1 fb2 fb3 fus gamehome gamingx gcp gctruykichpc gg1 gg2 gg3 hubservices kingzone mixed other rip113 spartacus viking waystation) do (
