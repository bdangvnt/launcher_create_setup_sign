...
[Icons]
Name: {group}\AU2 PC; Filename: {app}\VTCPlus.exe; WorkingDir: {app}
Name: {group}\Uninstall;IconFileName:{#rsBP}\inno\inno-images\uninstall.ico; Filename: {uninstallexe}
Name: {userdesktop}\AU2 PC; Filename: {app}\VTCPlus.exe; WorkingDir: {app}; Tasks: desktopicon
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\AU2 PC; Filename: {app}\VTCPlus.exe; WorkingDir: {app}
...
Filename: {app}\VTCPlus.exe; Description: {cm:LaunchProgram,AU2 PC}; Flags: nowait postinstall skipifsilent
