...
;#define MyAppExeName "TieuNgaoVTC.exe"
...
DefaultGroupName=VTC\Tieu Ngao Giang Ho VTC
...
[Icons]
Name: {group}\VTC; Filename: {app}\TieuNgaoVTC.exe; WorkingDir: {app}
Name: {group}\Uninstall;IconFileName:{#rsBP}\inno\inno-images\uninstall.ico; Filename: {uninstallexe}
Name: {userdesktop}\Tieu Ngao VTC; Filename: {app}\TieuNgaoVTC.exe; WorkingDir: {app}; Tasks: desktopicon
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\VTC; Filename: {app}\TieuNgaoVTC.exe; WorkingDir: {app}
...
Filename: {app}\TieuNgaoVTC.exe; Description: {cm:LaunchProgram,VTC}; Flags: nowait postinstall skipifsilent
...
Root: HKCR; Subkey: "VTC\DefaultIcon"; ValueType: "string"; ValueData: "{app}\TieuNgaoVTC.exe,0"
Root: HKCR; Subkey: "VTC\shell\open\command"; ValueType: "string"; ValueData: """{app}\TieuNgaoVTC.exe"" ""%1"""
